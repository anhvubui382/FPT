...
public class teacherManageController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        teachers = staffDAO.selectTeachers(); // Giả sử bạn đã cài đặt phương thức selectTeachers trong StaffDAO


        request.setAttribute("teachers", teachers);
        RequestDispatcher dispatcher = request.getRequestDispatcher("adminTeacherHome.jsp");
