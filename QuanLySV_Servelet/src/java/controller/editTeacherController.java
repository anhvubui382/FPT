...
public class editTeacherController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("doGet editTeacher: " + id);
        int staffID = Integer.parseInt(id); // Chuyển 'id' từ String sang int
        StaffDAO staffDAO = new StaffDAO();
        
        Staff teacher = staffDAO.selectById(staffID);

        
        request.setAttribute("teacher", teacher);

        
        RequestDispatcher dispatcher = request.getRequestDispatcher("/editTeacherHome.jsp");
